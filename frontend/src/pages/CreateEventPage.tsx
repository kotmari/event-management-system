  ...
  return (
    <div className="max-w-6xl mx-auto px-6 pt-24 pb-12">
      ...
      <div className="max-w-2xl mx-auto p-6 bg-white shadow rounded-lg">
        <h2 className="text-2xl font-bold">Create New Event event</h2>
        <p>Fill in the details to create an amazing event </p>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-6">
          <Input
            label="Event Title" //добавити сюди червнону зірку
            type="text"
          ...
          />
          <Textarea
            label="Description" //добавити сюди червону зірку
            rows={3}
          ...
          <Input
            label="Location" //добавити сюди червнону зірку
            type="text"
